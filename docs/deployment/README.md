...
| I want to…                                                        | Read                                                                                                                                                     |
| ----------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Upgrade production to the current release**                     | **[`upgrading.md`](upgrading.md)** — the complete `0.1.2`→`0.1.3` procedure; use the `0.1.3`→`0.1.4` addendum when the deployed stack is already `0.1.3` |
...
| ----------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| **`0.1.4`** | 2026-09-25 | Research input, report delivery, citation/document rendering, Chat cases, compatibility hardening, and G13–G17 release gates | [`history/upgrade-0.1.3-to-0.1.4.md`](history/upgrade-0.1.3-to-0.1.4.md)         |
