...
// parsed separately) and normalizes newlines to the literal "\n" the viewer
// requires. Image URLs are already backend /api/v1/gene-images/ paths, so there
// is deliberately NO client-side image rewriting here.
