    ...
    <div class="global-config-container">
      ...
      <el-card class="history-card">
        ...
        <PhyTableFrame>
          <el-table
            :data="configHistory"
            class="global-config-history-table"
            style="width: 100%"
          >
...
import { PhyTableFrame, PhyWorkspaceShell } from "@/components/shell";
