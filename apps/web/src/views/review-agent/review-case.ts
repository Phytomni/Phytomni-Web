export const REVIEW_CASE = {
  ...
  references: [
    ...
    },
    {
      ...
      formatted_citation:
        "Robertson, S. M. & Wilkins, O. Spatially resolved gene regulatory networks in Asian rice (*Oryza sativa* cv. Nipponbare) leaves. *PLANT JOURNAL* **116,** 269–281 (2023). [https://doi.org/10.1111/tpj.16375](https://doi.org/10.1111/tpj.16375)",
      au: "Robertson, SM; Wilkins, O",
      ti: "Spatially resolved gene regulatory networks in Asian rice (Oryza sativa cv. Nipponbare) leaves",
      so: "PLANT JOURNAL",
      vl: "116",
      bp: "269",
      ep: "281",
    ...
    },
    {
      ...
      formatted_citation:
        "Conde, D. et al. A robust method of nuclei isolation for single-cell RNA sequencing of solid tissues from the plant genus *Populus*. *PLOS ONE* **16,** e0251149 (2021). [https://doi.org/10.1371/journal.pone.0251149](https://doi.org/10.1371/journal.pone.0251149)",
      ar: "e0251149",
      au: "Conde, D; Triozzi, PM; Balmant, KM; Doty, AL; Miranda, M; Boullosa, A; Schmidt, HW; Pereira, WJ; Dervinis, C; Kirst, M",
      ti: "A robust method of nuclei isolation for single-cell RNA sequencing of solid tissues from the plant genus Populus",
      so: "PLOS ONE",
      vl: "16",
      py: "2021",
    ...
    },
    {
      ...
      formatted_citation:
        "Long-term balancing selection at the Phosphorus *Starvation Tolerance 1* (*PSTOL1*) locus in wild, domesticated and weedy rice (*Oryza*). *BMC PLANT BIOLOGY* **16,** 101 (2016). [https://doi.org/10.1186/s12870-016-0783-7](https://doi.org/10.1186/s12870-016-0783-7)",
      ar: "101",
      ti: "Long-term balancing selection at the Phosphorus Starvation Tolerance 1 (PSTOL1) locus in wild, domesticated and weedy rice (Oryza)",
    ...
    },
    {
      ...
      title: "单细胞转录组测序技术发展及其在甘薯中的应用（赵楠）",
      formatted_citation: "单细胞转录组测序技术发展及其在甘薯中的应用（赵楠）",
      doi_missing: true,
    },
    {
