...
export default {
  ...
  chat: {
    ...
    execution: {
      ...
      decisionNote: "决策说明",
      phaseCompleted: "{phase}已完成",
      phaseFailed: "{phase}失败",
      historyTruncated: "仅显示最近 {count} 条活动记录",
      rail: "执行任务和结果",
      todo: "待办",
      results: "结果",
      workspace: "执行工作区",
      workspaceTabs: "已打开的执行项目",
      backToChat: "返回聊天",
      closeTab: "关闭 {title}",
      todoUnavailable: "该智能体未声明待办计划。",
      noResults: "暂无结果文件。",
      noOpenTabs: "点击活动或结果以在此处查看。",
      mediaType: "媒体类型",
      size: "大小",
      targetType: "资源类型",
      targetId: "资源标识",
      ...
      authorizedPreviewHint:
        "内容将通过当前对话的所有权校验后加载，不会直接打开上游地址。",
      previewUnavailable: "该资源的安全预览尚不可用。",
      cancel: "取消执行",
      cancelFailed: "无法取消执行，请刷新后重试。",
      actionFailed: "无法提交执行操作，请刷新后重试。",
      loadingTarget: "正在验证并加载资源…",
      targetUnavailable: "资源不存在、无权访问或暂时不可用。",
      reconnecting: "活动流正在重新连接，已保留现有记录。",
      gap: "检测到活动记录缺口，正在同步权威状态。",
      stale: "活动暂时不可更新，当前显示的是已验证记录。",
      active: "智能体仍在运行 · 已用时 {elapsed} 秒 · 最近活动 {quiet} 秒前",
      activeConnected:
        "智能体仍在运行 · 事件流连接正常 · 已用时 {elapsed} 秒 · 最近活动 {quiet} 秒前",
      providerContact: "{quiet} 秒前已联系外部服务",
      streamConnected: "事件流连接正常",
      streamContact: "最近一次事件流联系在 {quiet} 秒前",
      progress: "{completed}/{total} {unit}",
      attemptHistory: "尝试历史",
      analysisBranches: "分析分支",
      submissionAttempts: "提交与重试明细",
      attemptCount: "{count} 次尝试",
      attempt: "第 {attempt} 次尝试 · {status}",
      currentAttempt: "第 {attempt} 次尝试",
      retryDelay: "{delay} 后重试",
      ...
      executionLog: "执行日志",
      workflowPlan: "任务计划",
      workflowPlanSteps: "{count} 个步骤",
      technicalDetails: "技术明细",
      technicalEventCount: "{count} 条协议事件",
      diagnostics: {
        total: "条协议事实",
        displayed: "条在本页显示",
        truncated: "其余记录已分页",
        ...
        all: "全部",
        groups: "协议事件分组统计",
        groupsBounded: "显示 {displayed}/{total} 个分组",
        ledger: "协议事件日志",
        pagination: "协议事件分页",
      },
      trace: {
        feed: "分析工作记录",
        lastSemanticActivity: "最近一项有效活动",
        lastProviderContact: "最近一次外部服务联系",
        ...
        health: {
          healthy: "活动记录已同步",
          degraded: "活动记录同步延迟",
          unavailable: "活动记录暂不可用",
        },
        geneNetwork: {
          validateTarget: "校验性状目标",
          prepareInputs: "准备分析输入",
          inferNetwork: "推断调控网络",
          rankRegulators: "排序候选调控因子",
          synthesizeResults: "汇总网络结果",
        },
      },
      pending: {
        submitted: "正在提交分析…",
        running: "分析正在运行…",
        consolidating: "正在收集分析结果…",
        settling: "正在准备答复…",
      },
      operationStatus: {
        pending: "等待中",
      ...
      operation: {
        ...
        review: {
          ...
          draftDimension: "撰写章节",
          finalSynthesis: "汇总报告",
          retrieveDimension: "检索证据",
        },
      },
      operationDetail: {
        artifact_count: "产物数",
        result_count: "结果数",
        repository_count: "知识库数",
        provider_state: "外部服务状态",
        ordinal: "序号",
        total: "总数",
        gene_count: "基因数",
        interaction_count: "互作数",
        input_count: "输入数",
        regulator_count: "候选调控因子数",
        target_validated: "目标已校验",
      },
      counterUnit: {
        artifacts: "个产物",
        rows: "行",
    ...
    lifecycle: {
      assistantPreparing: "准备中……",
      assistantWorking: "处理中……",
      preparing: "准备中",
