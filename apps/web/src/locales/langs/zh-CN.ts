...
export default {
  ...
  tutorial: {
    step1: {
      title: "欢迎使用 Phytomni！",
      content:
        '首先，让我们了解一下导航功能。快速访问功能："开始新对话"启动全新任务，"基因展示"让您查看基因信息，"收藏夹"用于收集常用内容，还有按时间分类的历史交互记录，帮助您高效查找过往记录。',
      button: '点击"下一步"继续探索！',
    },
    step2: {
      title: "智能代理演示",
      content:
        "底部的这些按钮是不同智能代理的演示。您可以点击查看具体使用案例。",
      button: '点击"下一步"了解对话区域。',
    },
    step3: {
      title: "对话窗口",
      content:
        '这是与 Phytomni 交流的"窗口"。您可以直接输入问题，或者自主选择不同的智能助手，如"ChatAgent"和"KnowledgeAgent"。试试点击输入框。准备好开始探索了吗？',
      button: '点击"完成"结束引导！',
    },
    nextStep: "下一步",
    prevStep: "上一步",
  ...
  login: {
    ...
    accountLockedMessage:
      "由于多次登录失败，您的账户已被锁定 {minutes} 分钟，请稍后再试。",
  ...
  help: {
    ...
    faq: {
      ...
      q1: {
        question: "如何获得更准确的回答？",
        answer:
          "建议您提供具体、详细的问题描述，包括相关的背景信息和具体需求。同时可以上传相关的文档或数据文件来获得更精准的分析结果。",
      },
      q2: {
        question: "支持哪些文件格式？",
        answer:
          "我们支持 PDF、Word、Excel、PowerPoint、TXT、PNG 等常见格式的文件上传，单个文件大小建议不超过10MB。",
      },
      q3: {
        question: "如何选择合适的智能代理？",
        answer:
          "根据您的具体需求选择：聊天代理用于一般问答，知识代理用于文献检索，数据代理用于数据分析，分析代理用于生物信息学分析。",
      },
      q4: {
        question: "数据安全如何保障？",
        answer:
          "我们采用企业级安全措施保护您的数据，包括数据加密、访问控制、定期备份等，确保您的数据安全和隐私保护。",
      },
    },
    contact: {
      title: "联系我们",
