...
export default {
  ...
  chat: {
    ...
    execution: {
      ...
      historyTruncated: "Showing the latest {count} activity entries",
      rail: "Execution tasks and results",
      todo: "Todo",
      results: "Results",
      workspace: "Execution workspace",
      workspaceTabs: "Open execution items",
      backToChat: "Back to chat",
      closeTab: "Close {title}",
      todoUnavailable: "This Agent did not declare a Todo plan.",
      noResults: "No result files yet.",
      noOpenTabs: "Open an activity or result to inspect it here.",
      mediaType: "Media type",
      size: "Size",
      targetType: "Resource type",
      targetId: "Resource identity",
      eventKind: "Event kind",
      eventStatus: "Status",
      occurredAt: "Occurred at",
      authorizedPreviewHint:
        "Content is loaded only after ownership is checked for this conversation; upstream addresses are never opened directly.",
      previewUnavailable:
        "A safe preview is not available for this resource yet.",
      cancel: "Cancel execution",
      cancelFailed:
        "The execution could not be cancelled. Refresh and try again.",
      actionFailed:
        "The execution action could not be submitted. Refresh and try again.",
      loadingTarget: "Verifying and loading the resource…",
      targetUnavailable:
        "This resource is unavailable or you no longer have access.",
      reconnecting: "Reconnecting activity; verified records remain visible.",
      gap: "An activity gap was detected; synchronizing authoritative state.",
      stale: "Activity is temporarily unavailable; showing verified records.",
      active:
        "Agent is still running · {elapsed}s elapsed · last activity {quiet}s ago",
      activeConnected:
        "Agent is still running · event stream connected · {elapsed}s elapsed · last activity {quiet}s ago",
      providerContact: "Provider contacted {quiet}s ago",
      streamConnected: "Event stream connected",
      streamContact: "Last event-stream contact {quiet}s ago",
      progress: "{completed}/{total} {unit}",
      attemptHistory: "Attempt history",
      analysisBranches: "Analysis branches",
      submissionAttempts: "Submission and retry details",
      ...
      workflowPlan: "Todo plan",
      workflowPlanSteps: "{count} steps",
      technicalDetails: "Technical details",
      technicalEventCount: "{count} protocol events",
      diagnostics: {
        total: "total protocol facts",
        displayed: "displayed on this page",
        truncated: "additional rows are paged",
        export: "Export authorized ledger",
        kind: "Event kind",
        source: "Source",
        status: "Status",
        all: "All",
        groups: "Grouped protocol statistics",
        groupsBounded: "Showing {displayed} of {total} groups",
        ledger: "Protocol ledger",
        pagination: "Protocol event pages",
      },
      trace: {
        feed: "Analysis work trace",
        lastSemanticActivity: "Last meaningful activity",
        lastProviderContact: "Last provider contact",
        ...
        health: {
          healthy: "Trace current",
          degraded: "Trace delayed",
          unavailable: "Trace unavailable",
        },
        geneNetwork: {
          validateTarget: "Validate trait target",
          prepareInputs: "Prepare analysis inputs",
          inferNetwork: "Infer regulatory network",
          rankRegulators: "Rank candidate regulators",
          synthesizeResults: "Synthesize network results",
        },
      },
      pending: {
        submitted: "Submitting the analysis…",
        running: "The analysis is running…",
        consolidating: "Collecting the analysis results…",
        settling: "Preparing the answer…",
      },
      operationStatus: {
        pending: "Pending",
        queued: "Queued",
      ...
      operation: {
        ...
        artifact: { package: "Package results" },
        data: { query: "Query data" },
        knowledge: { search: "Search knowledge" },
        model: { generate: "Generate response" },
        remote: {
          analysis: "Run analysis",
          reconcile: "Collect analysis",
          submit: "Submit analysis",
        },
        review: {
          citationCheck: "Check citations",
          draftDimension: "Draft section",
          finalSynthesis: "Synthesize report",
          retrieveDimension: "Retrieve evidence",
        },
      },
      operationDetail: {
        ...
        input_count: "Inputs",
        regulator_count: "Candidate regulators",
      ...
      provider: {
        ...
        acknowledged: "External analysis is queued",
      ...
      status: {
        ...
        partial: "Execution completed with partial results",
      ...
      todoPhase: {
        ...
        consolidation: "Consolidate the results",
        response: "Prepare the response",
        understanding: "Understand the request",
        responding: "Prepare the response",
        retrieving: "Retrieve evidence and data",
        generating: "Generate the response",
        rewriting: "Refine the query",
        querying: "Run the data query",
        preparing: "Prepare the analysis",
        analyzing: "Run the analysis",
        publishing: "Publish the results",
        planning: "Plan the work",
        drafting: "Draft the report",
        revising: "Review and revise",
        annotating: "Collect gene annotations",
        synthesizing: "Synthesize the findings",
        researching: "Investigate the evidence",
        designing: "Develop candidate designs",
        consolidating: "Consolidate the results",
      },
    },
    a2ui: {
      confirm: "Confirm",
