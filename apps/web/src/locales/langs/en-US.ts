...
export default {
  ...
  tutorial: {
    step1: {
      ...
      content:
        'First, let\'s get to know the navigation. Quick access to functions: "Start New" initiates a brand-new task, "Gene Display" allows you to view gene displays, "Favorites" is for collecting frequently-used content, and there are also historical interactions categorized by time to help you efficiently find past records.',
  ...
  login: {
    ...
    accountLockedMessage:
      "Your account has been locked for {minutes} minutes due to multiple failed login attempts. Please try again later.",
  ...
  chat: {
    ...
    favoritesDescription:
      "Manage your favorite conversations and quickly access important content",
  ...
  cloudStorage: {
    ...
    noFilesDescription:
      "Current folder is empty. Upload your first file or create a folder to get started",
  ...
  feedback: {
    title: "User Feedback",
    description:
      "We value your opinions and suggestions. Please let us know what you think",
    placeholder:
  ...
  help: {
    ...
    quickStart: {
      ...
      step1: {
        ...
        description:
          "Use your email and password to login to the Phytomni platform",
      },
      step2: {
        title: "Start Conversation",
        description:
          "Enter your questions in the chat interface, AI assistant will provide professional answers",
      },
      step3: {
        title: "Upload Files",
        description:
          "Support uploading PDF, Word, Excel and other format files for analysis",
      },
      step4: {
        title: "Use Intelligent Agents",
        description:
          "Select different professional agents to assist you with specific tasks",
      },
    },
    features: {
      title: "Core Features",
      research: {
        title: "Deep Research",
        description:
          "Conduct in-depth research analysis based on massive literature and databases",
      ...
      analysis: {
        ...
        description:
          "Professional bioinformatics analysis tools and algorithms",
      ...
      design: {
        title: "Data Design",
        description:
          "Intelligent experimental design and data analysis solutions",
    ...
    agents: {
      ...
      chat: {
        name: "Chat Agent",
        description:
          "Your AI assistant for answering plant science research questions in natural language",
        capability1: "Natural Language Understanding",
        capability2: "Multi-turn Conversation",
        capability3: "Context Memory",
        usage:
          "Directly input questions to get professional answers and suggestions",
      },
      knowledge: {
        name: "Knowledge Agent",
        description:
          "Provides authoritative plant science knowledge base and literature search",
        capability1: "Knowledge Retrieval",
        capability2: "Literature Analysis",
        capability3: "Expert Knowledge Integration",
        usage:
          "Query professional knowledge and latest research progress in specific fields",
      },
      data: {
        name: "Data Agent",
        ...
        usage:
          "Upload data files to get professional analysis results and charts",
      },
      analysis: {
        name: "Analysis Agent",
        ...
        usage:
          "Input gene sequences or protein information to get detailed functional analysis",
      },
    },
    tips: {
      title: "Usage Tips",
      question: {
        ...
        description:
          "Use specific and clear question descriptions to get more accurate answers",
      },
      upload: {
        title: "File Upload",
        description:
          "Supports multiple file formats, recommended file size not exceeding 10MB",
      },
      followup: {
        title: "Follow-up Questions",
        description:
          "Based on AI responses, you can continue to ask in-depth questions for more detailed information",
      },
      save: {
        title: "Save Conversations",
        description:
          "Important conversations can be favorited and saved for future viewing and sharing",
      },
    },
    faq: {
      ...
      q1: {
        ...
        answer:
          "We recommend providing specific and detailed question descriptions, including relevant background information and specific needs. You can also upload relevant documents or data files to get more precise analysis results.",
      },
      q2: {
        question: "What file formats are supported?",
        answer:
          "We support common file formats such as PDF, Word, Excel, PowerPoint, TXT, PNG, etc. Individual file size is recommended not to exceed 10MB.",
      },
      q3: {
        question: "How to choose the right intelligent agent?",
        answer:
          "Choose based on your specific needs: Chat Agent for general Q&A, Knowledge Agent for literature search, Data Agent for data analysis, Analysis Agent for bioinformatics analysis.",
      },
      q4: {
        question: "How is data security guaranteed?",
        answer:
          "We adopt enterprise-level security measures to protect your data, including data encryption, access control, regular backups, etc., to ensure your data security and privacy protection.",
      },
    },
    contact: {
      title: "Contact Us",
      ...
      documentationDesc:
        "View detailed usage documentation and API specifications",
    },
  },
};
