...
// Standalone vitest config — does NOT mergeConfig() vite.config.mts because
  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/utils/scientific-markdown/citations.ts",
        "src/utils/scientific-markdown/headings.ts",
        "src/utils/scientific-markdown/resources.ts",
        ...
        "src/components/ScientificMarkdown.vue",
        "src/components/scientific/ScientificRenderBoundary.vue",
        "src/permission.ts",
