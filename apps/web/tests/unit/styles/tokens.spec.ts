...
describe("PHY_TOKENS", () => {
  ...
  it("exports the approved spacing, controls, layout, and responsive values", () => {
    expect({
      ...
      documentMaxWidth: PHY_TOKENS.documentMaxWidth,
      readingMaxWidth: PHY_TOKENS.readingMaxWidth,
      artifactWideMaxWidth: PHY_TOKENS.artifactWideMaxWidth,
      artifactDocumentMaxWidth: PHY_TOKENS.artifactDocumentMaxWidth,
      ...
      transcriptMaxWidth: "clamp(860px, 72vw, 1600px)",
      documentMaxWidth: "clamp(1120px, 78vw, 1600px)",
      readingMaxWidth: "clamp(760px, 52vw, 1160px)",
  ...
  it("keeps the token sheet as the single source for layout measures", () => {
    const declarations = [
      ...
      "--phy-layout-document-max-width",
      "--phy-layout-reading-max-width",
      "--phy-layout-artifact-wide-max-width",
